...
int main(int argc,char** argv)
{
  ...
  if(myrank==0){
    ...
    printf("MY_GROUP1234567 has process:");
    printf_ranknumber_in_world(MY_GROUP1234567,WORLD_GROUP);
    printf("MY_GROUP12345_ has process:");
    printf_ranknumber_in_world(MY_GROUP12345_,WORLD_GROUP);
    printf("MY_GROUP54321 has process:");
    printf_ranknumber_in_world(MY_GROUP54321,WORLD_GROUP);
    printf("MY_GROUP13567 has process:");
    printf_ranknumber_in_world(MY_GROUP13567,WORLD_GROUP);
  }
